      ...
      chai
        ...
        .end(function (error, response) {
          ...
          assert.equal(
            ...
            "the text property must be equal to the original text"
          );
          assert.equal(
            response.body.translation,
            'Mangoes are my <span class="highlight">favourite</span> fruit.',
            "the translation property must include the right translation"
          );
          done();
        });
    });
      ...
      chai
        ...
        .end(function (error, response) {
          ...
          assert.property(
            response.body,
            "error",
            "the response must include the error property"
          );
          assert.equal(
            response.body.error,
            "Invalid value for locale field",
            "the response must be Invalid value for locale field"
          );
          done();
        });
    });
      ...
      chai
        ...
        .end(function (error, response) {
          ...
          assert.equal(
            ...
            "the response must be Required field(s) missing"
          );
          done();
        });
    });
      ...
      chai
        ...
        .end(function (error, response) {
          ...
          assert.equal(
            ...
            "the response must be No text to translate"
          );
          done();
        });
    });
      ...
      chai
        ...
        .end(function (error, response) {
          ...
          assert.equal(
            ...
            "the translation property must be Everything looks good to me!"
          );
          done();
        });
    });
