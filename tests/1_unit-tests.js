...
suite("Unit Tests", () => {
  ...
  suite("American to British English", (locale = "american-to-british") => {
    test("Translate Mangoes are my favorite fruit. to British English", function () {
      assert.equal(
        transation(translator, "Mangoes are my favorite fruit.", locale),
        "Mangoes are my favourite fruit."
      );
    });
    test("Translate I ate yogurt for breakfast. to British English", function () {
      assert.equal(
        transation(translator, "I ate yogurt for breakfast.", locale),
        "I ate yoghurt for breakfast."
      );
    });
    test("Translate We had a party at my friend's condo. to British English", function () {
      assert.equal(
        transation(translator, "We had a party at my friend's condo.", locale),
    ...
    test("Translate The parking lot was full. to British English", function () {
      assert.equal(
        transation(translator, "The parking lot was full.", locale),
    ...
    test("Translate No Mr. Bond, I expect you to die. to British English", function () {
      assert.equal(
        transation(translator, "No Mr. Bond, I expect you to die.", locale),
        "No Mr Bond, I expect you to die."
      );
    });
    test("Translate Dr. Grosh will see you now. to British English", function () {
      assert.equal(
        transation(translator, "Dr. Grosh will see you now.", locale),
        "Dr Grosh will see you now."
      );
    });
    test("Translate Lunch is at 12:15 today. to British English", function () {
      assert.equal(
        transation(translator, "Lunch is at 12:15 today.", locale),
  ...
  suite("British to American English", (locale = "british-to-american") => {
    ...
    test("Translate First, caramelise the onions. to American English", function () {
      assert.equal(
        transation(translator, "First, caramelise the onions.", locale),
    ...
    test("Translate Have you met Mrs Kalyani? to American English", function () {
      assert.equal(
        transation(translator, "Have you met Mrs Kalyani?", locale),
    ...
    test("Translate Tea time is usually around 4 or 4.30. to American English", function () {
      assert.equal(
        transation(translator, "Tea time is usually around 4 or 4.30.", locale),
        "Tea time is usually around 4 or 4:30."
      );
    });
  });
  suite(
    "Highlight translation to British English ",
    (locale = "american-to-british") => {
      test("Highlight translation in Mangoes are my favorite fruit.", function () {
        const translation = translator.translation(
  ...
  suite(
    "Highlight translation to American English ",
